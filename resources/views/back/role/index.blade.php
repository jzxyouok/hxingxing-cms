...
@parent
          <a href="{{ route('admin.role.create') }}" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i> 新增角色</a>
          <ol class="breadcrumb">
                ...
                <div class="box-body table-responsive">
                  <table class="table table-hover table-bordered">
                    <tbody>
                      ...
                      <tr>
                        <td>
                            <a href="{{ route('admin.role.index') }}/{{ $role->id }}/edit"><i class="fa fa-fw fa-edit" title="修改"></i></a>  
