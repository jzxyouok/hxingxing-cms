                  ...
                  <table class="table table-hover table-bordered">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-muted">@if( count($user->works) > 1)<a href="javascript:void(0)" data-title="{{ $user->name }}" data-works="{{ $user->works }}" class="openModal" data-toggle="modal" data-target="#pageModal"><i class="fa fa-file-video-o"></i></a>@endif</td>
