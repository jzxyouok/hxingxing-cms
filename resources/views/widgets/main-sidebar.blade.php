          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
               ...
               {{-- <li><a href="{{ route('admin.statistics.index') }}"><i class="fa fa-area-chart"></i> 统计</a></li>--}}
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ route('admin.user.index') }}"><i class="fa fa-user-md"></i>用户</a></li>
                <!-- <li><a href="#"><i class="fa fa-circle-o"></i>付费客户</a></li> -->
                <li><a href="{{ route('admin.role.index') }}"><i class="fa fa-users"></i>角色</a></li>
                <li><a href="{{ route('admin.system_log.index') }}"><i class="fa fa-list"></i>系统日志</a></li>
                <li><a href="{{ route('admin.cache') }}"><i class="fa fa-eraser"></i> 重建缓存</a></li>
