 ...
 */
class Statistics extends Model implements AuthenticatableContract, CanResetPasswordContract
{
    ...
    public function targetreportPerson()
    {
        //模型名 外键 本键
        return $this->hasOne('Douyasi\Models\User', 'id', 'targetId');
    }
