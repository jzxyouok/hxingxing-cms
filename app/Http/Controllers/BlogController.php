...
class BlogController extends CommonController
{
    ...
    {
        $slides = Content::article()->where('category_id', 3)->orderBy('is_top', 'desc')->orderBy('id', 'desc')->get();
        $articles = Content::article()->whereIn('category_id', array('1', '2'))->orderBy('is_top', 'desc')->orderBy('id', 'desc')->paginate(6);
        $title = '首页';
        ...
        return view('front.index', compact('articles', 'slides', 'title', 'description'));
    }
