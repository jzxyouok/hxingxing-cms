        ...
        $("#unpub").jsGrid({
            ...
            controller: {
                ...
                insertItem: function(item) {
                    item._token=_token;
                    item.pubStatus=0;
                    return $.post(operaController,item);
                },
            ...
            fields: [
                ...
                {headerTemplate: function() {
                    ...
                    itemTemplate: function(_, item) {
                        return $("<button>").attr({"type":"button","title":item.contact?item.contact.name:'',"class":"btn btn-default btn-sm",'data-target':'#contactModal','data-toggle':'modal'}).html(item.contact?item.contact.name:'<i class="fa fa-edit"></i>')
                        .on("click", function () {
                ...
                { name: "categoryC", title: "类型", type: "select", width: 100, items: tagsData.jobCategory, valueField: "id", textField: "name" },
                ...
                { name: "platform", title: "播放平台", type: "text", width: 60 },
